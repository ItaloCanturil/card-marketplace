...
<template>
  <div class="flex flex-col items-center flex-1 w-full mt-10">
    ...
    <div v-if="filteredCards.length" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 w-full place-items-center">
    ...
    <div v-if="!loading && !filteredCards.length" class="flex flex-col items-center justify-center mt-5">
